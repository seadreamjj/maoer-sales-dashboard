...
<div class="stats"><div class="stat"><div class="label">剧目数量</div><div id="n" class="value gold">—</div></div><div class="stat"><div class="label">稳定在榜</div><div id="stable" class="value">—</div></div><div class="stat"><div class="label">新晋</div><div id="new" class="value">—</div></div><div class="stat"><div class="label">掉榜 / 闪现</div><div id="drop" class="value">—</div></div><div class="stat"><div class="label">统计范围</div><div id="range" class="value" style="font-size:14px">—</div></div></div>
